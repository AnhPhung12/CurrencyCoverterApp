...
Performance Optimization: Implemented Singleton Pattern and Caching mechanisms to lightning-fast responses

Smart Data Parsing: Automatically handles various numeric formats (e.g., users can input '100.000', '100,000', or '100000')

Billingual Localization: Converts numbers to Vietnamese text for VND transactions

Converts numbers to English text for international currencies(USD, EUR, JPN,..)

Modern Dark Mode UI: High-quality desktop experience powered by the 'Customtkinter' library
